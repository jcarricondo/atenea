<?php
// PROCESO DE DESRECEPCIÓN DE PERIFÉRICOS
...
if(isset($_POST["iniciarAlbaran"]) and $_POST["iniciarAlbaran"] == 1){
    ...
    if($nombre_albaran != ""){
        ...
        if($resultado == 1) {
            ...
            $proceso = "CREACION ALBARAN DESRECEPCION PERIFERICOS";
            $hubo_error = "NO";
            $error_des = "OK!";
            ...
            header("Location: desrecepcion_perifericos.php?iniciarDesRecepcion=1&id_albaran=".$id_albaran);
        }
        else {
...
$titulo_pagina = "Almacen Periféricos > Salida Periféricos";
$pagina = "desrecepcion_perifericos";
...
<div id="ContenedorCentral">
    ...
    <h3>Salida Perif&eacute;ricos</h3>
    ...
    <?php 
        if($_GET["iniciarDesRecepcion"] != 1){
            ...
            <form id="FormularioCreacionBasico" name="iniciarAlbaran" action="desrecepcion_perifericos.php" method="post">
                <br/>
                ...
                <?php 
                    ...
                    $res_motivos = $albaranPeriferico->dameMotivosAlbaranSalidaPerifericos($id_almacen_usuario);
                ?>
    ...
    <?php
        ...
        <?php
            ...
            <form id="FormularioCreacionBasico" name="finalizarAlbaran" action="desrecepcion_perifericos.php" method="post">
