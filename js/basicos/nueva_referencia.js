// JavaScript Document
// Fichero que contiene las funciones JavaScript utilizadas en el proceso de creación de una referencia

// Función para crear nuevos campos dinamicamente para agregar archivos 
...
function rellenarTipoPieza(){
	...
	if (checkbox.checked){
      ...
      tipo_pieza.readOnly = true;
	}
	else{
		// Eliminamos el texto ORDENADOR
		tipo_pieza.value = "";
      tipo_pieza.readOnly = false;
	}
}
