// JavaScript Document
// Fichero que contiene las funciones JavaScript utilizadas en el proceso de creación de una cabina
	...
	for(i=0;i<fl.options.length;i++){
		if(fl.options[i].selected){
            ...
            var respuesta = (function () {
                ...
                $.ajax({
                    dataType: "json",
                    url: "../ajax/basicos/nueva_cabina.php?func=loadComp",
...
// Funcion que suma el precio de un kit al precio total de la cabina
...
// Funcion que resta el precio de un kit al precio total de la cabina
