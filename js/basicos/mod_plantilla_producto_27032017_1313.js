/**
 * Created by Jacho on 03/07/2015.
 */
...
function MostrarTodosPerifericos(){
    ...
    var input_buscador = document.getElementById("BuscadorPerModPlantilla");
    input_buscador.setAttribute("onkeyup","BuscadorDinamicoComponentes('todos','BuscadorPerModPlantilla','perifericos_no_asignados[]')");
    ...
    BuscadorDinamicoComponentes('todos','BuscadorPerModPlantilla','perifericos_no_asignados[]');
}
...
function MostrarPerProduccion(){
    ...
    var input_buscador = document.getElementById("BuscadorPerModPlantilla");
    input_buscador.setAttribute("onkeyup","BuscadorDinamicoComponentes('produccion','BuscadorPerModPlantilla','perifericos_no_asignados[]')");
    ...
    BuscadorDinamicoComponentes('produccion','BuscadorPerModPlantilla','perifericos_no_asignados[]');
}
...
function MostrarTodosKits(){
    ...
    var input_buscador = document.getElementById("BuscadorKitModPlantilla");
    input_buscador.setAttribute("onkeyup","BuscadorDinamicoComponentes('todos','BuscadorKitModPlantilla','kits_no_asignados[]')");
    ...
    BuscadorDinamicoComponentes('todos','BuscadorKitModPlantilla','kits_no_asignados[]');
}
...
function MostrarKitProduccion(){
    ...
    var input_buscador = document.getElementById("BuscadorKitModPlantilla");
    input_buscador.setAttribute("onkeyup","BuscadorDinamicoComponentes('produccion','BuscadorKitModPlantilla','kits_no_asignados[]')");
    ...
    BuscadorDinamicoComponentes('produccion','BuscadorKitModPlantilla','kits_no_asignados[]');
}
