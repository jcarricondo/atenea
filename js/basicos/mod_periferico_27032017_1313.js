// JavaScript Document
// Fichero que contiene las funciones JavaScript utilizadas en el proceso de modificacion de un periférico
...
var div = document.getElementById('CapaTablaIframe');
	...
	// Funcion para eliminar una referencia del periférico
	...
	function MostrarTodosKits(){
		...
		var input_buscador = document.getElementById("BuscadorKitModPeriferico");
		input_buscador.setAttribute("onkeyup","BuscadorDinamicoComponentes('todos','BuscadorKitModPeriferico','kits_no_asignados[]')");
		...
		BuscadorDinamicoComponentes('todos','BuscadorKitModPeriferico','kits_no_asignados[]');
	}
	...
	function MostrarKitProduccion(){
		...
		var input_buscador = document.getElementById("BuscadorKitModPeriferico");
		input_buscador.setAttribute("onkeyup","BuscadorDinamicoComponentes('produccion','BuscadorKitModPeriferico','kits_no_asignados[]')");
		...
		BuscadorDinamicoComponentes('produccion','BuscadorKitModPeriferico','kits_no_asignados[]');
	}