<?php
// Este fichero realiza la busqueda de referencias. Es el buscador de referencias de basicos
...
function add_referencia(id_referencia){
	...
	if (!error_piezas) {
		...
		window.opener.addRow('mitabla',id_referencia);
	}
...
<div id="ContenedorCentralReferencias">
	<h3> Añadir referencia a <?php echo $componente;?> </h3>
	<div id="ContenedorBuscadorReferencias">
		<h4> Buscar la referencia para añadir a <?php echo $componente;?> </h4>
   		<form name="BuscadorReferencias" id="BuscadorReferencias" action="buscador_referencias.php?componente=<?php echo $componente;?>" method="post">
