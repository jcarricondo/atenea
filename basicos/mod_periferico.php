	...
	if(($nombre == '') || ($referencia == '') || ($descripcion == '') || ($version == '')){
		...
		if($seguir){
			...
			if($resultado == 1){
				...
				$perifericos->datosNuevoPeriferico($id_componente,$nombre,$referencia,$descripcion,$version,$referencias,$piezas,2,$nombre_archivo,NULL,$estado,$prototipo,$kits);
				...
				if($resultado == 1) {
					...
					if($duplicado == 1) {
						...
						$perifericos->datosNuevoPeriferico(NULL,$nombre,$referencia,$descripcion,$version,$referencias,$piezas,2,$nombre_archivo,NULL,$estado,$prototipo,$kits);
						$resultado = $perifericos->guardarCambios();
						if($resultado == 1) {
