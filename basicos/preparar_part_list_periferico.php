...
for($i=0;$i<count($referencias_componente);$i++){
	...
	<tr>
		...
		<td style="text-align: left;">'.utf8_decode($ref->part_valor_cantidad).'</td>
		<td style="text-align: left;">'.$valor_nombre2.'</td>
		<td style="text-align: left;">'.utf8_decode($ref->part_valor_cantidad_2).'</td>
		<td style="text-align: left;">'.$valor_nombre3.'</td>
		<td style="text-align: left;">'.utf8_decode($ref->part_valor_cantidad_3).'</td>
		<td style="text-align: left;">'.$valor_nombre4.'</td>
		<td style="text-align: left;">'.utf8_decode($ref->part_valor_cantidad_4).'</td>
		<td style="text-align: left;">'.$valor_nombre5.'</td>
		<td style="text-align: left;">'.utf8_decode($ref->part_valor_cantidad_5).'</td>
		<td style="text-align: right;">'.number_format($ref->pack_precio,2,',','.').'</td>
		<td style="text-align: right;">'.utf8_decode($ref->unidades).'</td>
		<td style="text-align: right;">'.$coments.'</td>
