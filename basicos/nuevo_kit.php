...
echo '<script type="text/javascript" src="../js/basicos/nuevo_kit.js"></script>';
...
<div id="ContenedorCentral">
    ...
    <form id="FormularioCreacionBasico" name="crearKit" action="nuevo_kit.php" method="post" enctype="multipart/form-data">
    	<br />
