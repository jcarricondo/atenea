<?php
// Este fichero crea un nuevo proveedor de basicos
include("../includes/sesion.php");
include("../classes/funciones/funciones.class.php");
include("../classes/basicos/proveedor.class.php");
permiso(2);

if(isset($_POST["guardandoProveedor"]) and $_POST["guardandoProveedor"] == 1) {
	...
	elseif (!$validacion->verificarSoloDigitos($codigo_postal)){
		...
		$proveedor->datosNuevoProveedor(NULL,$nombre,$descripcion,$direccion,$ciudad,$pais,$telefono,$email,$forma_pago,$tiempo_suministro,$metodo_pago,$provincia,$codigo_postal,$persona_contacto);
		$resultado = $proveedor->guardarCambios();
		if($resultado == 1) {
			header("Location: proveedores.php?prov=creado");
		} else {
...
$titulo_pagina = "Básico > Nuevo proveedor";
$pagina = "new_proveedor";
...
<div id="ContenedorCentral">
    ...
    <h3> Creaci&oacute;n de un nuevo proveedor </h3>
    
    <form id="FormularioCreacionBasico" name="crearProveedor" action="nuevo_proveedor.php" method="post">
    	<br />
        <h5> Rellene los siguientes campos para la creaci&oacute;n de un nuevo proveedor </h5>
        ...
        <div class="ContenedorBotonCreacionBasico">
            ...
            <input type="hidden" id="guardandoProveedor" name="guardandoProveedor" value="1" />
