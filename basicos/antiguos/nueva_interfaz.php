...
// Este fichero crea una nueva interfaz
			...
			if((!$archivos_adjuntos) or (($subido) and ($error_archivo == 0))) { 		
				...
				if($resultado == 1) {
					...
					if($metodo == "masivo"){
						...
						$id_componente = $interfaces->getExisteComponente($nombre,$version,4);
						$tipo_componente = "INTERFAZ";
						$proceso = "NUEVA INTERFAZ";
						include("../basicos/log_importacion_referencias_componente.php");
						header("Location: interfaces.php?interface=creado");
					}
					else {
						header("Location: interfaces.php?interface=creado");
					}	
...
$componente = "interfaz";
$titulo_pagina = "Básico > Nueva interfaz";
$pagina = "new_interfaz";
include ('../includes/header.php');
echo '<script type="text/javascript" src="../js/basicos/nueva_interfaz.js"></script>';
echo '<script type="text/javascript" src="../js/basicos/nueva_interfaz_adjuntos.js"></script>';
?>
...
<div id="ContenedorCentral">
    ...
    <h3> Creaci&oacute;n de una nueva interfaz </h3>
    <form id="FormularioCreacionBasico" name="crearInterfaz" action="nueva_interfaz.php" method="post" enctype="multipart/form-data">
    	<br />
        <h5> Rellene los siguientes campos para la creaci&oacute;n de una nueva interfaz </h5>
