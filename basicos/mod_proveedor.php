<?php
// Este fichero modifica un proveedor de basicos
...
if(isset($_POST["guardandoProveedor"]) and $_POST["guardandoProveedor"] == 1) {
	...
	elseif (!$validacion->verificarSoloDigitos($codigo_postal)){
		...
		if($resultado == 1) {
			header("Location: proveedores.php?prov=modificado");
		} 
		else {
...
$titulo_pagina = "Básico > Modifica proveedor";
$pagina = "mod_proveedor";
...
<div id="ContenedorCentral">
    ...
    <h3> Modificación de proveedor </h3>
    
    <form id="FormularioCreacionBasico" name="modificarProveedor" action="mod_proveedor.php?id=<?php echo $proveedor->id_proveedor; ?>" method="post">
    	<br />
