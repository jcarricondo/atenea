...
<div id="ContenedorCentral">
    ...
    <form id="FormularioCreacionBasico" name="crearPeriferico" onsubmit="return SeleccionarComponentes()" action="nuevo_periferico_her.php" method="post" enctype="multipart/form-data">
    	<br />
