...
<div class="ContenedorCamposCreacionBasico">
    ...
    <?php
        if($modificar) { ?>
            <div class="CapaBuscadorDinamicoComponentes">
                ...
                <input type="text"
                       id="BuscadorPerModPlantilla"
                       name="BuscadorPerModPlantilla"
                       class="BuscadorComponente"
                       onkeyup="BuscadorDinamicoComponentes('produccion','BuscadorPerModPlantilla','perifericos_no_asignados[]');"
    ...
    <?php
            ...
            <div class="contenedorComponentes">
                ...
                <tr>
                    <td id="lista_per" style="width:250px; border:1px solid #fff; padding-left:0px; padding-top:0px;">
    ...
    <div class="ContenedorCamposCreacionBasico">
        ...
        <div class="contenedorComponentes">
            ...
            <tr>
                ...
                <td id="lista_per" style="width:250px; border:1px solid #fff;">
