...
// Este script convierte los almacenes de la tabla albaranes_perifericos en los almacenes actuales
...
for($i=0;$i<count($res_albaranes);$i++) {
    ...
    $updateSql = sprintf("update albaranes_perifericos set id_almacen=%s where id_albaran=%s",
