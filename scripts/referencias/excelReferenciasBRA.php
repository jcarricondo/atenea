...
// Excel con todas las referencias de BRA
...
$consulta = "select * from referencias_brasil where activo=1";
...
for($i=0;$i<count($res);$i++){
	...
	$consulta_fab = sprintf("select nombre_fab from fabricantes_brasil where activo=1 and id_fabricante=%s",
...
header("Content-Disposition: attachment; filename=excelReferenciasBRA.xls");
