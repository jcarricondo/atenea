<?php
// PROCESO DE RECEPCION DE SIMULADORES
...
if(isset($_POST["iniciarAlbaran"]) and $_POST["iniciarAlbaran"] == 1){
    ...
    if($nombre_albaran != ""){
        ...
        if($resultado == 1) {
            ...
            $proceso = "CREACION ALBARAN RECEPCION SIMULADORES";
            $hubo_error = "NO";
            $error_des = "OK!";
            ...
            header("Location: recepcion_simuladores.php?iniciarRecepcion=1&id_albaran=".$id_albaran);
        }
        else {
...
$titulo_pagina = "Almacen Simuladores > Entrada Simuladores";
$pagina = "recepcion_simuladores";
...
<div id="ContenedorCentral">
    ...
    <?php 
        if($_GET["iniciarRecepcion"] != 1){
            ...
            <form id="FormularioCreacionBasico" name="iniciarAlbaran" action="recepcion_simuladores.php" method="post">
                <br/>
                ...
                <div class="ContenedorCamposCreacionBasico">
                    ...
                    <select id="motivo" name="motivo"  class="CreacionBasicoInput">
                        <?php
                            if($esAdminGlobal) $motivos_entrada = array("AJUSTE DESVIACION","COMPRA / SUMINISTRO","SERVICIO REPARACION","MERMA","NACIONALIZAÇÃO","ARMAZENAGEM","MOVIMENTAÇÃO ARMAZÉNS","MERMA","EXPLORAÇÃO","AJUSTE DESVIO","OUTROS" );
                            else if($esUsuarioBrasil) $motivos_entrada = array("NACIONALIZAÇÃO","ARMAZENAGEM","MOVIMENTAÇÃO ARMAZÉNS","MERMA","EXPLORAÇÃO","AJUSTE DESVIO","OUTROS");
                            else $motivos_entrada = array("AJUSTE DESVIACION","COMPRA / SUMINISTRO","SERVICIO REPARACION","MERMA");
    ...
    <?php
        ...
        <?php
            ...
            <form id="FormularioCreacionBasico" name="finalizarAlbaran" action="recepcion_simuladores.php" method="post">
