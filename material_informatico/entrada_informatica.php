<?php
// PROCESO DE RECEPCIÓN DE MATERIAL INFORMÁTICO
...
if(isset($_POST["iniciarAlbaran"]) and $_POST["iniciarAlbaran"] == 1){
    ...
    if($nombre_albaran != ""){
        ...
        $albaranInformatico->datosNuevoAlbaran($id_albaran,$nombre_albaran,$tipo_albaran,$motivo,$id_usuario,$id_almacen,$origen,$observaciones,$fecha,$activo);
        $resultado = $albaranInformatico->guardarAlbaran();
        if($resultado == 1){
            $id_albaran = $albaranInformatico->id_albaran;
            header("Location: entrada_informatica.php?iniciarRecepcion=1&id_albaran=".$id_albaran);
        }
        else {
...
$titulo_pagina = "Material Informático > Entrada Informática";
$pagina = "entrada_informatica";
...
<div id="ContenedorCentral">
    ...
    <h3>Entrada Inform&aacute;tica</h3>

    <?php 
        if($_GET["iniciarRecepcion"] != 1){    
            $fecha_hoy =  date('Y-m-d H:i:s');
            $fecha_hoy_spain = $user->fechaHoraSpain($fecha_hoy); ?>            
            <form id="FormularioCreacionBasico" name="iniciarAlbaran" action="entrada_informatica.php" method="post">
                <br/>
                ...
                <div class="ContenedorCamposCreacionBasico">
                    ...
                    <select id="motivo" name="motivo"  class="CreacionBasicoInput">
                        <?php
                            $motivos_entrada = array("COMPRA / SUMINISTRO","PENDIENTE REPARACION","MATERIAL REPARADO");
                ...
                <div class="ContenedorCamposCreacionBasico">
                    ...
                    <input type="text" id="origen" name="origen" class="CreacionBasicoInput" value="<?php echo $origen;?>" />
                </div>
                <div class="ContenedorCamposCreacionBasico">
    ...
    <?php
            ...
            $origen = $albaranInformatico->origen_destino;
            ...
            $nombre_almacen = $almacen->nombre;
    ?>
            <form id="FormularioCreacionBasico" name="finalizarAlbaran" action="entrada_informatica.php" method="post">
                ...
                <div class="ContenedorCamposCreacionBasico">
                    <div class="LabelCreacionBasico">Origen</div>
                    <label id="origen" class="LabelInfoOP" style="width:750px;"><?php echo $origen;?></label>
                </div>
                <div class="ContenedorCamposCreacionBasico">
                    <div class="LabelCreacionBasico">Observaciones</div>
