<?php
// PROCESO DE RECEPCION DE MATERIAL DEL ALMACEN
...
if(isset($_POST["iniciarAlbaran"]) and $_POST["iniciarAlbaran"] == 1){
    ...
    if($nombre_albaran != ""){
        // Guarda el registro de albarán y prepara las tablas para la recepción
        ...
        if($tipo_correcto){
            ...
            if($resultado == 1) {
                ...
                $proceso = "CREACION ALBARAN RECEPCION PIEZAS";
                $hubo_error = "NO";
                $error_des = "OK!";
                ...
                header("Location: recepcion_material.php?iniciarRecepcion=1&id_albaran=".$id_albaran);
            }
            else {
...
$titulo_pagina = "Almacen > Entrada Material";
$pagina = "recepcion_material";
...
<div id="ContenedorCentral">
    ...
    <?php 
        if($_GET["iniciarRecepcion"] != 1){
            ...
            <form id="FormularioCreacionBasico" name="iniciarAlbaran" action="recepcion_material.php" method="post">
                <br/>
                ...
                <?php
                    ...
                    if($eligeCualquierAlmacen){ ?>
                        <div class="ContenedorCamposCreacionBasico">
                            ...
                            <select id="almacenes" name="almacenes" class="CreacionBasicoInput" onchange="cargaMotivos(this.value,'ENTRADA')">
                                <?php 
                                    for($i=0;$i<count($res_almacenes);$i++){
                                        $id_almacen = $res_almacenes[$i]["id_almacen"];
                                        $nombre_almacen = $res_almacenes[$i]["almacen"];
                                        echo '<option value="'.$id_almacen.'">'.$nombre_almacen.'</option>';
                                    }
                                ?>
                            </select>
                        </div>
                ...
                <?php
                        ...
                        // Si no es admin sólo su almacen asignado ?>
                        <div class="ContenedorCamposCreacionBasico">
                            <div class="LabelCreacionBasico">Almacen</div>
                            <label id="almacenes" class="LabelInfoOP">
                                <?php 
                                    // Obtenemos el almacen del usuario
                                    $almacen->cargaDatosAlmacenId($id_almacen_usuario);
                ...
                <?php 
                    ...
                    // Cargamos los motivos del albarán de entrada
                    $res_motivos = $almacen->dameMotivosAlbaranEntrada($id_almacen_usuario);
                ?>
    ...
    <?php
        ...
        <?php
            ...
            <form id="FormularioCreacionBasico" name="finalizarAlbaran" action="recepcion_material.php" method="post">
                ...
                <div class="ContenedorCamposCreacionBasico">
                    ...
                    <input type="button" class="BotonEliminar" style="margin: 3px 0px 0px 10px;" value="BUSCADOR" onclick="javascript:Abrir_ventana('buscador_referencias_almacen.php?metodo=RECEPCIONAR')" />
                </div>
                <br/>
                ...
                <br/>
                <br/>
                <input type="button" id="btn_cerrar_albaran" class="BotonEliminar" style="margin: 5px 5px 5px 12px;" value="CERRAR ALBARAN" onclick="javascript: cerrarAlbaran(<?php echo $id_albaran; ?>)" />
