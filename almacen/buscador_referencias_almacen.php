<?php
// Este fichero realiza la busqueda de referencias. Es el buscador de referencias de almacen
...
function add_referencia(id_referencia){
	...
	metodo = document.getElementById("metodo_utilizado").value;
	...
	if (!error_piezas) {
		...
		window.opener.id_referencia = identificador;
		window.opener.nombre_referencia = referencia; 
		window.opener.nombre_proveedor = proveedor;
		window.opener.referencia_proveedor = ref_proveedor;
		window.opener.nombre_pieza = nombre_pieza;
		window.opener.cantidad_referencia = piezas;
		window.opener.pack_precio = p_precio; 
		window.opener.unidades_paquete = cantidad;
		window.opener.boton = boton;
		
		window.opener.addReferencia('mitabla',id_referencia,metodo);
...
<div id="ContenedorCentralReferencias">
	...
	<div id="ContenedorBuscadorReferencias">
		<h4>Buscar la referencia para el almacen</h4>
   		<form name="BuscadorReferenciasAlmacen" id="BuscadorReferenciasAlmacen" action="buscador_referencias_almacen.php" method="post">
        	...
        	<div class="ContenedorBotonBuscadorReferencias">
        		...
        		<input type="hidden" id="metodo_utilizado" name="metodo_utilizado" value="<?php echo $metodo;?>" />
            	<input type="submit" id="" name="" class="" value="Buscar" />
        	</div>
        	</br>
			<input type="hidden" id="nombreFormulario" name="nombreFormulario" value="BuscadorReferenciasAlmacen" />
    	</form>
    </div>
